...
it('builds shopping rows for board, sheet, and tile plans', () => {
  const rows = buildMaterialRows([
    ...
    },
    {
      ...
      options_data: { waste_percent: 10 },
      layout_result: { tiles_to_purchase: 8, tiles_to_purchase_with_waste: 9 },
    },
  ]);
  ...
  expect(rows).toEqual([
    ...
    { plan: 'Tiles', material: 'tile', size: '300 × 600 mm', quantity: 9, baseQuantity: 8, wastePercent: 10 },
  ]);
});
