...
def test_create_backup_uses_sqlite_backup_api_and_writes_manifest(tmp_path: Path):
    ...
    assert manifest["database"]["alembic_revision"] == "010_add_material_dimensions"
...
def _manifest(
    sha256: str, *, alembic_revision: str = "010_add_material_dimensions"
) -> dict[str, object]:
    return {
